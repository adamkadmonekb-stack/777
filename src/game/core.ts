...
// Топливо и товары для АЗС
fuel92: { id: 'fuel92', name: 'АИ-92 (л)', cat: 'fuel', stack: 100, price: 45, desc: 'Бензин АИ-92 для заправки' },
fuel95: { id: 'fuel95', name: 'АИ-95 (л)', cat: 'fuel', stack: 100, price: 52, desc: 'Бензин АИ-95 для заправки' },
fuel98: { id: 'fuel98', name: 'АИ-98 (л)', cat: 'fuel', stack: 100, price: 62, desc: 'Бензин АИ-98 для заправки' },
...
},
{
  ...
  name: 'АЗС «Лукойл»',
  kind: 'Заправки',
  seller: 'Оператор Игорь',
  phrase: '«Чем заправимся сегодня?»',
  wall: '#8a3e3e',
  floor: '#3a2a2a',
  tabs: ['Бензин','Дизель','Магазин'],
  goods: [
    { item: 'fuel92', price: 45, tab: 'Бензин' },
    { item: 'fuel95', price: 52, tab: 'Бензин' },
    { item: 'fuel98', price: 62, tab: 'Бензин' },
    { item: 'diesel', price: 55, tab: 'Дизель' },
